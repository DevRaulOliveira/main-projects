...
The project's goal was to demonstrate the connection phase between Microsoft Access and Power BI's Power Query. The connection was established using M Language; however, significant data cleaning was not required as the source was already standardized and easy to understand. The main focus was data manipulation to generate useful information in a Dashboard format, utilizing Programming Logic and DAX formulas.
...
- Unsplash, a site used for sourcing royalty-free images.

## Power BI Access Link

The dashboard is available at: [Adventure Works](https://app.powerbi.com/view?r=eyJrIjoiMWE4NzgzZjItN2NmMS00NzZhLWIwNWEtNzUyMTU2OTMwNWNmIiwidCI6ImNmNzJlMmJkLTdhMmItNDc4My1iZGViLTM5ZDU3YjA3Zjc2ZiIsImMiOjR9&embedImagePlaceholder=true)
